...
const CompanyLogos = () => {
  const companies = [
    { name: 'Digitech', fontFamily: 'font-semibold' },
    { name: 'Netdot', fontFamily: 'font-bold' },
    { name: 'Sparkweb', fontFamily: 'font-extrabold', hasIcon: true, iconType: 'rectangle' },
    { name: 'Pixelpath', fontFamily: 'font-semibold', hasIcon: true, iconType: 'square' },
    { name: 'CodeLine', fontFamily: 'font-bold' },
    { name: 'Digitech', fontFamily: 'font-semibold' }
  ];
        ...
        <div className="w-full flex justify-center items-start gap-4 flex-wrap">
          {companies.map((company, index) => (
            <div
              ...
              className="px-6 py-5 rounded-full border border-white/20 flex items-center gap-2"
              style={{
