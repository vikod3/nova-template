...
const CompanyLogos = () => {
  ...
  return <div className="w-full py-24 flex flex-col justify-center items-center gap-12 bg-black">
      <div className="w-full max-w-5xl flex flex-col justify-start items-center gap-8">
        <div className="w-full flex justify-center items-start gap-4 flex-wrap">
          {companies.map((company, index) => <div key={`${company.name}-${index}`} className="px-6 py-5 rounded-full border border-white/20 flex items-center gap-2" style={{
