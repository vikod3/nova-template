...
const Navbar = () => {
  ...
  return (
    <nav className="absolute top-4 left-4 right-4 z-50">
      <div className="max-w-[1029px] mx-auto" style={{
        background: 'rgba(21, 22, 26, 0.80)'
      }}>
        <div className="w-full px-4 py-3 rounded-2xl border border-[rgba(255,255,255,0.12)] backdrop-blur-[20px] flex justify-between items-center bg-[#15161a]/80">
          {/* Logo and Brand */}
