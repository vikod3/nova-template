  ...
  return (
    <nav className="absolute top-4 left-4 right-4 z-50">
      <div 
        ...
        style={{ background: 'rgba(21, 22, 26, 0.80)' }}
      >
        {/* Logo and Brand */}
        ...
        <div className="hidden lg:block">
          <Button
            className="px-4 py-2.5 text-sm font-semibold leading-5 text-white rounded-xl border border-white/32 font-sans"
            style={{ 
        ...
        <div className="lg:hidden">
          <Sheet open={isOpen} onOpenChange={setIsOpen}>
            ...
            <SheetContent 
              side="right" 
              className="w-[300px] bg-[#15161a]/95 border-white/12 backdrop-blur-[20px]"
            >
              <div className="flex flex-col space-y-6 mt-8">
                ...
                <div className="px-4 pt-4">
                  <Button
                    className="w-full px-4 py-3 text-sm font-semibold text-white rounded-xl border border-white/32"
                    style={{ 
                      background: 'linear-gradient(180deg, #6445F5 0%, #4128BA 100%)',
                    }}
                    onClick={() => setIsOpen(false)}
