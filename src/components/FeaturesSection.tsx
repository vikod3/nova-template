      ...
      <div className="w-full max-w-screen-xl flex flex-col justify-start items-center gap-12 md:gap-20">
        ...
        >
          ...
          <motion.div className="self-stretch flex flex-col justify-start items-center gap-6" variants={itemVariants}>
            <motion.div 
              className="self-stretch text-center text-white text-4xl md:text-6xl font-normal leading-tight md:leading-[67.20px] font-sans"
              variants={itemVariants}
            >
              Short heading goes here
            </motion.div>
            <motion.div 
              className="self-stretch text-center text-white text-base md:text-lg font-normal leading-6 md:leading-7"
        ...
        <motion.div 
          className="self-stretch flex flex-col justify-start items-start gap-6 md:gap-8"
          variants={containerVariants}
          initial="hidden"
          whileInView="visible"
          viewport={{ once: true, margin: "-100px" }}
        >
          <div className="self-stretch flex flex-col justify-start items-start gap-6 md:gap-8">
            <div className="self-stretch flex flex-col lg:flex-row justify-start items-start gap-6 md:gap-8">
              <motion.div 
                className="w-full lg:w-[864px] bg-gradient-to-b from-[#161A1E] to-[#08090A] overflow-hidden rounded-[32px] border-[rgba(255,255,255,0.12)] flex flex-col justify-start items-start min-h-[400px] md:min-h-0"
              ...
              <motion.div 
                className="flex-1 self-stretch bg-gradient-to-b from-[#161A1E] to-[#08090A] overflow-hidden rounded-[32px] border-[rgba(255,255,255,0.12)] flex flex-col justify-start items-start min-h-[400px] md:min-h-0"
                variants={cardVariants}
              >
