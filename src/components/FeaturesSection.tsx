      ...
      <div className="w-full max-w-screen-xl flex flex-col justify-start items-center gap-12 md:gap-20">
        <div className="w-full max-w-3xl flex flex-col justify-start items-center gap-4">
          ...
          <div className="self-stretch flex flex-col justify-start items-center gap-6">
            ...
            <div className="self-stretch text-center text-white text-base md:text-lg font-normal leading-6 md:leading-7" style={{
            fontFamily: 'Roboto'
            ...
            <div className="self-stretch flex flex-col lg:flex-row justify-start items-start gap-6 md:gap-8">
              ...
              <div className="flex-1 self-stretch bg-gradient-to-b from-[#161A1E] to-[#08090A] overflow-hidden rounded-[32px] border border-white flex flex-col justify-start items-start min-h-[400px] md:min-h-0">
                ...
                <div className="self-stretch flex-1 flex items-center justify-center p-6">
                  <img src="/lovable-uploads/b83a5e37-deef-435b-8cc2-ba4c3e283575.png" alt="Dashboard visualization" className="w-full h-full w-contain " />
                </div>
              </div>
            </div>
          </div>
